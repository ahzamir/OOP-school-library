...
describe Student do 
  ...
  describe "#new" do
    ...
    it 'throws error when arguments less than 3' do
       lambda { Student.new() }.should raise_exception ArgumentError
    end
    it 'throws error when arguments more than 3' do
       lambda { Student.new('classroom', 'age', 'any', 'extra_argument') }.should raise_exception ArgumentError
    end
  end
