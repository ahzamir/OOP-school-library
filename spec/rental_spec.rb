...
describe Rental do 
  ...
  describe "#new" do
    ...
    it 'throws error when arguments less than 3' do
       lambda { Rental.new('01/12/2022', 'a person') }.should raise_exception ArgumentError
    end
    it 'throws error when arguments more than 3' do
       lambda { Rental.new('date', 'person' ,'book', 'extra_argument') }.should raise_exception ArgumentError
    end
  end
